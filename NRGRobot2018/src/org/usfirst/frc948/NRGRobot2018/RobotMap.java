...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("Drive", "LeftFrontMotor", (Victor) driveLeftFrontMotor);
        driveLeftFrontMotor.setInverted(false);
        driveLeftRearMotor = new Victor(1);
        LiveWindow.addActuator("Drive", "LeftRearMotor", (Victor) driveLeftRearMotor);
        driveLeftRearMotor.setInverted(false);
        driveRightFrontMotor = new Victor(2);
        LiveWindow.addActuator("Drive", "RightFrontMotor", (Victor) driveRightFrontMotor);
        driveRightFrontMotor.setInverted(false);
        driveRightRearMotor = new Victor(3);
        LiveWindow.addActuator("Drive", "RightRearMotor", (Victor) driveRightRearMotor);
        driveRightRearMotor.setInverted(false);
        driveMecanumDrive = new MecanumDrive(driveLeftFrontMotor, driveLeftRearMotor,
              driveRightFrontMotor, driveRightRearMotor);
        LiveWindow.addActuator("Drive", "MecanumDrive", driveMecanumDrive);
